...
export default React.createClass({
  ...
  getInitialState() {
    return {
      ...
      audioSource: null,
      speakerLabels: true,
      'customization_id': "e663d44a-6b12-4afe-aba1-bfc172b05269",
  ...
  render() {
    ...
    return (
      ...
      >
         ...
         <p className={this.supportsSpeakerLabels() ? 'base--p' : 'base--p_light'} id="getStartedButton">
        ...
        <label className="base--inline-label" htmlFor="speaker-labels">
          Get Started! {this.supportsSpeakerLabels() ? '' : ' (Not supported on current model)'}
        </label>
      </p>  
      
      <div id="mainContainer">
        <div className="flex setup " id="flex-setup">
        ...
        <div className="flex buttons" style={{marginTop:"35px"}}>
          <br/><br/>
          <button className={micButtonClass} onClick={this.handleMicClick} id="recordButton">
